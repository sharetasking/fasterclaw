...
const Message = ({
    ...
    const showImage = attachedFile?.isImage === true ? attachedFile.previewUrl : image;
    const showDocument = attachedFile != null && !attachedFile.isImage
        ? attachedFile.name
        : document;

    const hasFile = (showImage != null && showImage !== "") ||
        (showDocument != null && showDocument !== "");

    const canSend = (value.trim() !== "" || attachedFile != null) && disabled !== true;
