...
export default async function DashboardPage() {
  ...
  const runningCount = instances.filter((i) => i.status.toUpperCase() === "RUNNING").length;
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your OpenClaw bot instances</p>
        </div>
          ...
          {instances.length === 0 ? (
            ...
            <div className="space-y-4">
              {instances.map((instance) => (
                <Link key={instance.id} href={`/dashboard/agents/${instance.id}`} className="block">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {regionLabels[instance.region] ?? instance.region} &bull;{" "}
                          {instance.aiModel}
                        </p>
                      </div>
                    </div>
